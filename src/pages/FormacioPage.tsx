...
const t = {};
const FormacioPage = () => <div className="bg-background min-h-screen py-14 px-4 flex flex-col items-center w-full animate-fade-in">
    ...
    <section className="container max-w-4xl w-full bg-white rounded-2xl shadow-circular p-8 mb-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-7 mt-4">
        {TALLERS.map((t, i) => <div key={t.titol} className="rounded-xl border border-gray/30 shadow-circular bg-gray/10 p-6 flex flex-col items-center text-center animate-fade-in" style={{
    ...
    <section className="container max-w-2xl px-0 w-full flex flex-col items-center mb-8 animate-fade-in">
      <div className="bg-primary rounded-2xl shadow-circular p-8 w-full flex flex-col items-center justify-center text-center">
        ...
        <div className="flex flex-col md:flex-row gap-4 items-center justify-center">
          ...
          <a href="https://calendly.com/elinkcat/30min" target="_blank" rel="noopener noreferrer" className="px-8 py-3 rounded-full bg-primary-foreground text-primary font-semibold text-lg shadow-circular border-2 border-white hover:scale-105 transition-transform duration-200">
            Reserva una trobada
          </a>
        </div>
      </div>
